            ...
            <div className="  rounded-lg w-full md:w-1/2">
                ...
                {isLoading ? (
                    ...
                    <form onSubmit={handleSubmit(handleCreateProduct)}>
                        ...
                        <button
                            type="submit"
                            className="text-white bg-blue-700 inline-flex gap-3 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                        >
