...
const VoucherTableRow = ({ record ,index  }) => {
  ...
  return (
    <tr className="group odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
      ...
      <td className="px-6 py-4 text-end record-price">{record.product.price}</td>
      <td className="px-6 py-4 text-end">
        ...
        <button
          onClick={() => handleAddQuantity(record.id)}
      ...
      <td className="px-6 py-4 text-end relative">
        <span className="record-cost">{record.product.price * record.quantity}</span>
      </td>
      <td>
        <button
