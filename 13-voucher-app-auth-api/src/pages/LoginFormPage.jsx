...
const LoginFormPage = () => {
    ...
    const [userCookies, setUserCookies] = useCookie('user');
    ...
    const handleLogin = async (data) => {
        ...
        if (res.status === 200) {
            ...
            setToken(json.token);
            setUserCookies(JSON.stringify(json.user));  
            navigate('/dashboard');
        } else {
                        ...
                        >
                            <div>
                                ...
                                <input
                                    ...
                                    id="email"
                                    {...register("email")}
                                    className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full text-xs p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
